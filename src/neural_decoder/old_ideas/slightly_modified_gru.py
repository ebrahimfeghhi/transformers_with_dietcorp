...
class GRUDecoder(nn.Module):
    ...
    def forward(self, neuralInput, dayIdx, inputType):
        ...
        # if neural input is predicted from the speech model, then skip
        # the gaussian smoothing +For day specific linear layer
        elif inputType == 'speech':
